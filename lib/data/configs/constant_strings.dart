...
import 'package:portfolio/data/models/activity.dart';
import 'package:portfolio/data/models/route_model.dart';
import 'package:portfolio/data/models/certificate.dart';
import 'package:portfolio/data/models/experience.dart';
import 'package:portfolio/data/models/project_info.dart';
import 'package:portfolio/data/models/quote.dart';
import 'package:portfolio/data/models/showcase_project.dart';
import 'package:portfolio/data/models/social_media.dart';

final List<RouteModel> ksMenu = [
  RouteModel(label: ksHome, route: '/'),
  RouteModel(label: ksProject, route: '/projects'),
  RouteModel(label: ksExperience, route: '/experience'),
  RouteModel(label: ksCertificates, route: '/certificates'),
  RouteModel(label: ksAbout, route: '/aboutme'),
  RouteModel(label: ksContact, route: '/contact'),
];

/// constant strings are prefixed with [ks]
const String ksFontFamily = "ShantellSans";

const String ksFlutterDeveloperAnd = "Courious ";
const String ksAiMlEnthusiast = "problem solver";
...
const String ksWorkEmail = "pascal-dohle@gmx.de";
const String ksWorkPhone = "+49 1739960713";
